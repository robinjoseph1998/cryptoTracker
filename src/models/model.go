...
type Cryptocurrency struct {
	...
	CurrentPrice     float64 `json:"current_price" gorm:"type:decimal(20,10);not null"`
	MarketCap        float64 `json:"market_cap" gorm:"type:decimal(20,2);not null"`
	Volume24h        float64 `json:"volume_24h" gorm:"type:decimal(20,2);not null"`
